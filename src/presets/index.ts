...
const presetOptions = [
  {
    ...
    name: 'Основные',
    data: [
      { name: 'H264 Очень быстро 1080p30', value: 'h264-very-fast-1080p30' },
      { name: 'H264 Очень быстро 720p30', value: 'h264-very-fast-720p30' },
      { name: 'H264 Очень быстро 480p30', value: 'h264-very-fast-480p30' },
      { name: 'H264 Быстро 1080p30', value: 'h264-fast-1080p30' },
      { name: 'H264 Быстро 720p30', value: 'h264-fast-720p30' },
      { name: 'H264 Быстро 480p30', value: 'h264-fast-480p30' },
      { name: 'H264 Высокий профиль ур. 4.2 6000K 1080p', value: 'h264-high-profile-level-4.2-6000-1080p' },
      { name: 'H264 Основной профиль ур. 4.0 3000K 720p', value: 'h264-main-profile-level-4.0-3000-720p' },
      { name: 'H264 Основной профиль ур. 3.1 1000K 480p', value: 'h264-main-profile-level-3.1-1000-480p' },
      { name: 'H264 Базовый профиль ур. 3.0 600K 360p', value: 'h264-baseline-profile-level-3.0-600-360p' },
  ...
  {
    id: 'saved',
    name: 'Сохранённые (локальное хранилище)',
    data: [],
  },
];
