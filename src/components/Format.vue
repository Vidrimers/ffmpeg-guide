<template>
  <div>
    <b-form-row>
      <b-col>
        <b-form-group label="Контейнер:" label-for="container">
          <b-form-select
            class="u-full-width"
      ...
      <b-col v-if="value.clip">
        <b-form-group label="Время начала:" label-for="start-time">
          <b-form-input
      ...
      <b-col v-if="value.clip">
        <b-form-group label="Время окончания:" label-for="stop-time">
          <b-form-input
