<template>
  <div class="editor">
    ...
    <Command :cmd="cmd" />
    <p class="disclaimer">
      *Сгенерированные параметры могут отличаться в зависимости от версии
      FFmpeg и конфигурации сборки. Протестировано на версии 4.3.1.</p>
