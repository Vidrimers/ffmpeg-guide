<template>
  <div class="queue">
    <b-button-group class="float-right mb-2">
      <b-button @click="clearJobs">Очистить всё</b-button>
    </b-button-group>
    ...
    >
      ...
      <template v-slot:row-details="row">
        <b-row class="mb-2">
          <b-col sm="2" class="text-sm-right"><b>Вход:</b></b-col>
          <b-col>{{ row.item.input }}</b-col>
        </b-row>

        <b-row class="mb-2">
          <b-col sm="2" class="text-sm-right"><b>Выход:</b></b-col>
          <b-col>
        ...
        <b-row class="mb-2">
          <b-col sm="2" class="text-sm-right"><b>Данные:</b></b-col>
          <b-col>
            <b-form-textarea
              class="code"
              rows="6"
        ...
        <b-row class="mb-2" v-if="row.item.status === 'completed'">
          <b-col sm="2" class="text-sm-right"><b>Просмотр:</b></b-col>
          <b-col>
        ...
        <b-row class="mb-2" v-if="row.item.error">
          <b-col sm="2" class="text-sm-right"><b>Ошибка:</b></b-col>
          <b-col>
            <div class="code">
              <b-form-textarea
                rows="3"
    ...
    <h2 class="text-center" v-if="items.length === 0">Нет задач в очереди</h2>
  </div>
</template>
